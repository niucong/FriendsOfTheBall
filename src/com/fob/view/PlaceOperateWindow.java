...
public class PlaceOperateWindow extends PopupWindow {

	private PlaceOperateWindow(Context context, View v, int width, int height,
	...
	public final static PlaceOperateWindow createDialog(Context context,
			int width, int height, FOBPageBase pageBase) {
		View v = LayoutInflater.from(context).inflate(
				R.layout.fob_popu_friend_operate, null);
		PlaceOperateWindow d = new PlaceOperateWindow(context, v, width,
				height, pageBase);
		return d;
	}
