...
public class FilePart extends PartBase {
     ...
     * @param out The output stream.
     * @throws IOException if an IO problem occurs.
     * @see com.share.com.share.net.request.multipart.httpclient.methods.multipart.Part#sendData(OutputStream)
     */
     ...
     * @return The length.
     * @throws IOException if an IO problem occurs
     * @see com.share.com.share.net.request.multipart.httpclient.methods.multipart.Part#lengthOfData()
     */    
