...
public class FOBAdapterPlaceWaitItem extends FOBAdapterItemBase {
	private final String TAG = "FOBAdapterPlaceWaitItem";
	...
	public FOBAdapterPlaceWaitItem(Context context, FOBStructPlace mode,
	...
	public View getView(View convertView, boolean isScrolling) {
		...
		if (bean != null) {
			...
			tv_deal.setTextColor(LoginActivity.getActivity().getResources()
					.getColor(R.color.tab_text_blue));
